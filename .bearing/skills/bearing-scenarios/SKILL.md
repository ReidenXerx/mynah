...
Match your task to a playbook. Always start with READ `gitnexus://repo/mynah/context`.
...
- [ ] gitnexus_impact({target, direction: "upstream", repo: "mynah"})
...
```
- [ ] gitnexus_detect_changes({ scope: "staged", repo: "mynah" })
...
```
- [ ] gitnexus_detect_changes({ scope: "compare", base_ref: "main", repo: "mynah" })
...
- [ ] READ gitnexus://repo/mynah/processes — pick matching flow
