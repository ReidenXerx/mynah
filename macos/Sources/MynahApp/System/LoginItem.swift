...
///
/// This is the whole replacement for `mynah/dictate/service.py` — 343 lines that
/// hand-wrote LaunchAgent plist XML, shelled out to `launchctl`, and copied
/// Apple's framework Python binary to `~/.local/share/mynah/mynah` so Activity
/// Monitor would show "mynah" instead of "Python" and so the TCC grant would
