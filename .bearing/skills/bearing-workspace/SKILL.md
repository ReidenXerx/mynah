...
description: >-
  Master index for mynah GitNexus usage in Cursor. Use at the start
...
```
READ gitnexus://repo/mynah/context   # or npm run bearing:agent-brief (autonomous)
READ gitnexus://repo/mynah/schema    # before ad-hoc Cypher
