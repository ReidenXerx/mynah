...
struct TuningTests {
    ...
    /// …/macos/Tests/MynahAppTests/TuningTests.swift → repo root.
    private static let repoRoot = URL(fileURLWithPath: #filePath)
        .deletingLastPathComponent()   // MynahAppTests
    ...
    /// MynahConfig.number does (Python writes both shapes).
    ...
    @Test("MynahConfig defaults match tuning.toml")
