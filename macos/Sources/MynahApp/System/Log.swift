...
///
///     log stream --predicate 'subsystem == "com.reidenxerx.mynah"' --level debug
///
...
enum Log {
    static let session = Logger(subsystem: "com.reidenxerx.mynah", category: "session")
    static let audio = Logger(subsystem: "com.reidenxerx.mynah", category: "audio")
    static let stt = Logger(subsystem: "com.reidenxerx.mynah", category: "stt")
    static let ui = Logger(subsystem: "com.reidenxerx.mynah", category: "ui")
}
